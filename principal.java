            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    if (solicitudApto) {
                        ...
                        Localidad localidadr = null;
                        switch (seleccionLocalidad) {
                            case 1:
                                localidadr = localidad1;
                                break;
                            case 2:
                                localidadr = localidad5;
                                break;
                            case 3:
                                localidadr = localidad10;
                                break;
                            default:
                                System.out.println("Error en la selección de localidad.");
                        }
                        if (localidadr != null) {
                            int boletosDisponibles = localidadr.getBoletosDisponibles();
                            int boletosAVender = Math.min(cantidadBoletos, boletosDisponibles);
                            int precioTotal = boletosAVender * localidadr.getPrecio();
                            if (precioTotal > comprador.getpresupuesto()) {
                                ...
                                localidadr.venderBoletos(boletosAVender);
                                System.out.println("Compra exitosa: " + boletosAVender + " boletos en " + localidadr.getNombre() + " por $" + precioTotal);
                            }
                        }
                    } else {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("Seleccione una localidad (1: Localidad 1, 2: Localidad 5, 3: Localidad 10): ");
                    ...
                    if (localidadr != null) {
                        System.out.println("Disponibilidad en " + localidadr.getNombre() + ": " + localidadr.getBoletosDisponibles() + " boletos disponibles.");
                    }
                    break;
                case 5:
                    int total_ganancias = (localidad1.getBoletosVendidos() * localidad1.getPrecio()) +
                                         (localidad5.getBoletosVendidos() * localidad5.getPrecio()) +
                                         (localidad10.getBoletosVendidos() * localidad10.getPrecio());
                    System.out.println("Reporte de caja: Ingresos totales $" + total_ganancias);
                    break;
                case 6:
